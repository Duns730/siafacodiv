		...
		<div class="">
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td style="width: 10%; padding-top: 4px; padding-bottom: 4px">
				        	{{ $proforma->negotiationProformas->negotiation->client->rif }}
				        </td>
				        <th style="width: 6%; padding-top: 4px; padding-bottom: 4px">
				        	Cliente 
				        </th>
				        <td style="padding-top: 4px; padding-bottom: 4px" colspan="3">
				        	{{ $proforma->negotiationProformas->negotiation->client->name }}
				        </td>
					  </tr>
				      <tr>
				        ...
				        <td style="width: 6%; padding-top: 4px; padding-bottom: 4px">
				        ...
				        <td style="padding-top: 4px;padding-bottom: 4px">
				        		{{ number_format($proforma->factor, 2, ',', '.')  }}
				        </td>
				      </tr>
				      <tr>
				         <th style="padding-top: 4px; padding-bottom: 4px">
				  ...
				  <table class="table text-right" >
				    <tbody  style="font-weight: bold;">
				      <tr>
				        ...
				        <td style="padding-top: 4px; padding-bottom: 4px"> 
				        	$ {{ number_format($proforma->tax_base_dollar, 2, ',', '.')  }} 
				        </td>
				        
				        <td style="padding-top: 4px; padding-bottom: 4px"> 
				        	{{ number_format($proforma->tax_base_bolivar, 2, ',', '.')  }} Bs.
				        </td>
				      </tr>
				      <tr>
				        <th style="padding-top: 4px; padding-bottom: 4px">
				        ...
				        <td style="padding-top: 4px; padding-bottom: 4px"> 
				        	$ {{ number_format($proforma->iva_dollar, 2, ',', '.')  }} 
				        </td>
				        <td style="padding-top: 4px; padding-bottom: 4px">
				        	{{ number_format($proforma->iva_bolivar, 2, ',', '.')  }} Bs.
				        </td>
				      </tr>
				      <tr>
				        <th style="padding-top: 4px; padding-bottom: 4px">
				        ...
				        <td style="padding-top: 4px; padding-bottom: 4px"> 
				        	$ {{ number_format($proforma->total_operation_dollar, 2, ',', '.') }}
				        </td>
				        <td style="padding-top: 4px; padding-bottom: 4px">
				        	{{ number_format($proforma->total_operation_bolivar, 2, ',', '.') }} Bs.
				        </td>
				      </tr>
				    </tbody>
				  </table>
			...
			<div class="col-md-12" style="position:fixed; bottom: 1.7cm;">
				<p class="well well-sm no-shadow">
					...
					Proforma Nro {{ $proforma->id }} / Fecha {{ $proforma->created_at->format('d/m/Y') }}<br>
