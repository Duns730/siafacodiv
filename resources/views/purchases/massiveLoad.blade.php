...
@section('title','Carga masiva de productos en compras')
	...
	<div class="col-md-12 col-sm-12 ">
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<massive-load-products-purchase id_purchase="{{ $id }}"></massive-load-products-purchase>
...
@endsection
@section('scripts')
 {!! Html::script('js/AppMassiveLoadPurchase.js') !!}
